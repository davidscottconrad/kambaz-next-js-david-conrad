...
export default function Lab1() {
  return (
    <div id="wd-lab1">
      <h3>Full Name: Chunling Ji</h3>
      <h3>Section: 05</h3>
      <Link href="https://github.com/jichunling/kambaz-next-js-cs5610-fa25-05" id="wd-github">Link to GitHub</Link>
      <br />
      <h2>Lab 1</h2>
      <h3>HTML Examples</h3>
      <div id="wd-h-tag">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          ...
          <li>Add milk slowly and stir until smooth</li>
          <li>Heat a pan and add a little butter</li>
          <li>Pour batter into the pan</li>
          <li>Cook until golden brown on both sides</li>
          <li>Serve with fresh fruit and syrup</li>
        </ol>
        ...
        <ul id="wd-your-books">
          <li>The Human History</li>
          <li>Flow</li>
          <li>Foundation of AI</li>
        </ul>
      </div>
